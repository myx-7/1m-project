        ...
        <div className="space-y-6 mt-6">
          <div className="bg-foreground/10 border border-foreground/20 rounded-lg p-4">
            <p className="text-sm text-foreground">
              <strong className="font-pixel">milliondollarpage.xyz</strong> is a modern reimagining of The Million Dollar Homepage, 
          ...
          <div className="space-y-4 pt-4 border-t border-border">
            <h3 className="font-semibold text-foreground font-pixel">Why milliondollarpage.xyz?</h3>
